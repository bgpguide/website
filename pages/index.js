			...
			<div className="h-[32rem] bg-gray-100/[75%] flex items-center">
				<div className="max-w-5xl mx-auto px-8">
					...
					<div className="pt-8 relative">
						...
						<div className={`${isFocused ? 'block hover:block focus-within:block' : 'hidden hover:block focus-within:block'} w-full bg-white rounded-lg border border-gray-200/[75%] mt-4 absolute flex flex-col gap-2 p-2 max-h-[16rem] overflow-y-auto white-bg-scrollkit z-[20]`}>
